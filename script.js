const CONFIG = {
    ...
    subQuestion: "Please say yes, Shawn? 🙁",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["Hehe, gak boleh nolak", "Coba lagi, sayang", "Yaudah aku anggap jawabannya YES aja (SSA= Suka suka Ajen)"],
    confirmTitle: "YEAAYY! Thanks for choosing a yes, sayangku 💗",
    confirmText: "From now on,",
    badgeText: "You're My Valentine",
    nextButton: "Next",
    repeatButton: "Once again",
    flowerTitle: "This is a special gift for you",
    takeBouquetButton: "Accept the gift",
    bouquetMessage: "Yeay! It's yours now, sayang 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Beloved Shawn",
    collageSubtitle: "Sayang, from the moment I met you, everything felt so much better. Happy valentine, sayangku 💕",
    nextCollageButton: "One more page",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: `It's hard to find words to explain how much I love you. No dictionary has enough words, no eloquence could express how much I miss you and love you. Thank you for choosing to stay, for choosing me, and for loving me so profoundly genuinely powerfully unconditionally. God, how humbling it is to be loved by you in such a deep way. It mends parts of me I didn’t even realize were hurting. Happy Valentine’s Day, sayang.

Today, tomorrow and in every other lives that we will ever be — I love you more than words could describe.`,
